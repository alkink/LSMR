...
BASE_CFG="LSTR_CULANE_2k_condlstr_parity_stdc_tgtinit"
SEED2="${1:-901}"
ITER="${2:-12500}"
SUFFIX="${3:-thr04}"
...
bash remote_run_parity_stdc_tgtinit_train.sh

echo "[2/6] seed317 test+eval"
bash remote_run_parity_stdc_tgtinit_test_eval.sh "${ITER}" "${SUFFIX}"
