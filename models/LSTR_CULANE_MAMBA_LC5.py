"""
LSTR_CULANE_MAMBA_LC5 — LSTR with BidirectionalMambaEncoder, loss_curves=5.0
=============================================================================

LSTR_CULANE_MAMBA ile aynı mimari, loss_curves override KALDIRILDI.
Orijinal default (5.0) kullanılıyor — Baseline ile fair comparison için.

Kullanım:
  python train.py LSTR_CULANE_MAMBA_LC5 --threads 16
  python test.py LSTR_CULANE_MAMBA_LC5 --testiter 500000 --modality eval --split testing
"""
import torch
...
class model(kp):
    def __init__(self, flag=False):
        ...
        print("[LSTR_CULANE_MAMBA_LC5] transformer.encoder → BidirectionalMambaEncoder (d_state=16)")
        print("[LSTR_CULANE_MAMBA_LC5] loss_curves = 5.0 (default, override YOK)")
...
class loss(AELoss):
    def __init__(self):
        ...
        print(f"[LSTR_CULANE_MAMBA_LC5] weight_dict: {self.criterion.weight_dict}")
